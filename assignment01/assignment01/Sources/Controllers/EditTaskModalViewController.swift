...
//  HIEHJ
//
//  Created by Sanghun K. on 2023/09/02.
//
...
class EditTaskModalViewController: UIViewController {
    ...
    private func setNavigationBar() {
        ...
        addBtn.tintColor = UIColor(red: 0.85, green: 0.67, blue: 0.46, alpha: 1.00)
    ...
    @objc private func deadlineTxtflTapped(sender: UIDatePicker) {
        ...
        done.tintColor = UIColor(red: 0.85, green: 0.67, blue: 0.46, alpha: 1.00)
